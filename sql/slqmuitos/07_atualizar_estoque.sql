-- ============================================================
-- Atualização completa de estoque — Agosto 2026
-- Usa INSERT ... ON CONFLICT para inserir novos ou atualizar qtd dos existentes
-- ATENÇÃO: compara pelo campo "nome" (case-insensitive via LOWER)
-- Execute no SQL Editor do Supabase
-- ============================================================

-- Função helper: upsert por nome
-- Se o produto já existe -> atualiza qtd e categoria
